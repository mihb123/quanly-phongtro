...
func TestZaloService_HandleWebhook_ImageProcessing_Success(t *testing.T) {
	...
	svc, err := zalosvc.NewZaloService(zaloClient, userRepo, roomRepo, tenantRepo, houseRepo, invoiceRepo, nil, nil, encKey)
	if err != nil {
...
func TestZaloService_HandleWebhook_ImageProcessing_RoomNotFound(t *testing.T) {
	...
	encKey := "z123456789abcdef0123456789abcdef"
	svc, _ := zalosvc.NewZaloService(zaloClient, userRepo, roomRepo, tenantRepo, houseRepo, nil, nil, nil, encKey)
...
func TestZaloService_SendInvoiceToZalo(t *testing.T) {
	...
	encKey := "z123456789abcdef0123456789abcdef"
	svc, _ := zalosvc.NewZaloService(zaloClient, userRepo, roomRepo, tenantRepo, nil, invoiceRepo, imageService, nil, encKey)
