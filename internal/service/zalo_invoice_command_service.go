...
func NewZaloInvoiceCommandService(invoiceService InvoiceService, invoiceRepo model.InvoiceRepository, roomRepo model.RoomRepository, houseRepo model.HouseRepository, tenantRepo model.TenantRepository, userRepo model.UserRepository, pendingRepo model.PendingInvoiceUpdateRepository, zaloClient ZaloClient, imageService ImageService, paymentService PaymentService, encryptionKey []byte, publicBaseURL string) ZaloInvoiceCommandService {
