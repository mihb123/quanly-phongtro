...
func NewZaloService(client ZaloClient, userRepo model.UserRepository, roomRepo model.RoomRepository, tenantRepo model.TenantRepository, houseRepo model.HouseRepository, invoiceRepo model.InvoiceRepository, imageService ImageService, paymentService PaymentService, hexKey string, publicBaseURL ...string) (ZaloService, error) {
