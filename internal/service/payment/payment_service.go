...
// ZaloMessenger is the minimal Zalo notification surface payment depends on.
// Declared here so the payment package does not import the zalo package.
...
func (s *paymentService) SetZaloService(zaloService ZaloMessenger) {
