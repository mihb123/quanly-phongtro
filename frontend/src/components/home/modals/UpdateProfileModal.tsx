...
import { UserCircle, Shield, Phone, Save, LogOut, Key } from 'lucide-react'
  ...
  return (
    <>
      ...
      {createPortal(
        ...
        >
      <Card className="w-full max-w-2xl bg-card text-card-foreground shadow-xl border border-border/40 safe-fade-in max-h-[95vh] flex flex-col overflow-y-auto rounded-3xl">
        <div className="p-5 md:p-6 border-b border-border/40 shrink-0 flex justify-between items-center">
