              ...
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full flex items-center justify-between py-3 px-4 rounded-xl border border-slate-100 bg-slate-50/50 hover:bg-slate-100 transition-all font-bold text-sm text-slate-700 select-none cursor-pointer"
                  >
                    <span className="flex items-center gap-2">
                      ⚙️ Điền thêm thông tin khác (Tùy chọn)
                    </span>
                    {showOptionalFields ? <ChevronUp className="w-4 h-4 text-slate-500" /> : <ChevronDown className="w-4 h-4 text-slate-500" />}
                  </button>
                </div>
