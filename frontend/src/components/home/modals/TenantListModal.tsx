...
import { Plus, Trash2, Pencil, X, ExternalLink, FileIcon, ZoomIn, Download, CheckCircle2 } from '@/components/icons'
...
// Modal danh sách người thuê. Vỏ dùng AppModal; giữ nguyên hook useTenantList, xóa/sửa và lightbox xem trước file thủ công.
